...
// the following string contains parts of http://www.unicode.org/Public/6.0.0/ucd/DerivedCoreProperties.txt
let xidProperties = @"
...
# Total code points: 100724" + (* VS 2010 crashes for too long strings *) @"
